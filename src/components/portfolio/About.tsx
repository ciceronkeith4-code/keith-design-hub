    ...
    <section id="about" className="full-page-slide stacked-panel panel-dark z-20 px-4 py-28 sm:py-36 md:py-44">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-16 lg:grid-cols-[1fr_1.1fr] lg:gap-24">
        ...
        <Reveal delay={0.12}>
          ...
          <div className="mt-8 space-y-6 text-sm leading-relaxed text-neutral-300 sm:text-base"><p>I'm currently pursuing a Bachelor of Science in Information Technology at San Sebastian College – Recoletos Manila. Driven by a passion for software development and web technologies, I love designing and building digital systems that solve real-world problems.</p><p>My developer philosophy is rooted in simplicity, clean code structure, and meticulous attention to user interfaces. I bridge the gap between creative UI/UX designs and high-performance server logic.</p></div>
